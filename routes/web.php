...
Route::group(['namespace' => 'App\Http\Controllers\Frontend', 'as' => 'frontend.'], function () {
    ...
    Route::get('/jobs-search', 'FrontendController@jobSearch')->name('jobs.search');
    Route::get('/contact', 'FrontendController@contact')->name('contact');
    Route::get('/blog', 'FrontendController@blog')->name('blog');
    Route::get('/blog-detail/{id}', 'FrontendController@blogShow')->name('blog.detail');
    Route::get('/clientFaq', 'FrontendController@clientFaq')->name('client-Faq');
    Route::get('/employeeFaq', 'FrontendController@employeeFaq')->name('employee-Faq');

    Route::get('/apply/{id}', 'FrontendController@apply')->name('apply');

    Route::post('/applyJob/{position}', 'FrontendController@applyJob')->name('apply-Job');

    Route::post('/jobs/{job}/increment-clicks', 'FrontendController@incrementClicks')->name('jobs.increment-clicks');

    Route::post('/submitForm', 'FrontendController@submitForm')->name('submitForm');

    Route::get('/export-csv', 'FrontendController@exportToCSV' )->name('exportToCSV');
